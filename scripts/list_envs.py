...
All the environments are registered in the `franka_pickup` extension. They start
...
import franka_pickup.tasks  # noqa: F401


def main():
    """Print all environments registered in `franka_pickup` extension."""
